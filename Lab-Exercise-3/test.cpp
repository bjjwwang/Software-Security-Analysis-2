...
int main(int argc, char** argv) {
	...
	if (test_name == "test0") {
		...
		mgr.svf_assert(mgr.getAEState()[mgr.getNodeID("x")].getInterval() == IntervalValue(5, 5));
		mgr.reset();
	}
		...
		mgr.svf_assert(mgr.getAEState()[mgr.getNodeID("b")].getInterval() > IntervalValue(0, 0));
		mgr.reset();
	}
		...
		mgr.svf_assert(mgr.getAEState()[mgr.getNodeID("b")].getInterval() > IntervalValue(3, 3));
		mgr.reset();
	}
		...
		mgr.svf_assert(mgr.getAEState()[mgr.getNodeID("x")].getInterval() == IntervalValue(10, 10));
		mgr.reset();
	}
		...
		mgr.svf_assert(mgr.getAEState()[mgr.getNodeID("a")].getInterval() + mgr.getAEState()[mgr.getNodeID("b")].getInterval() > IntervalValue(20, 20));
		mgr.reset();
	}
		...
		mgr.svf_assert(mgr.getAEState()[mgr.getNodeID("z")].getInterval() == IntervalValue(15, 15));
		mgr.reset();
	}
		...
		mgr.svf_assert(mgr.getAEState()[mgr.getNodeID("b")].getInterval() >= IntervalValue(5, 5));
		mgr.reset();
	}
		...
		mgr.svf_assert(mgr.getAEState()[mgr.getNodeID("x")].getInterval() == IntervalValue(3, 3));
		mgr.svf_assert(mgr.getAEState()[mgr.getNodeID("y")].getInterval() == IntervalValue(2, 2));
		mgr.reset();
	}
		...
		mgr.svf_assert(mgr.getAEState()[mgr.getNodeID("x")].getInterval() == IntervalValue(0, 0));
		mgr.reset();
	}
	else {
